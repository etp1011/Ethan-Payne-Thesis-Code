...
Variables_For_Input = [Lambda_DL; Lambda_LL; DL; LL; Lambda_R]; %Random Variable Vector of Limit State Function (Last variable is does not require a Initial Design Point[x*])****
...
Initial_Design_Point_DL = 229.89;
Initial_Design_Point_LL = 266.04;

Initial_Design_Points_For_Input = [Initial_Design_Point_Lambda_DL; Initial_Design_Point_Lambda_LL; Initial_Design_Point_DL; Initial_Design_Point_LL;]; %Vector of Initial Design Points (x*) [None required for last variable listed if Variables vector] ****
...
Lambda_DL_Mew_Input = 0.0037635;
Lambda_DL_Sigma_Input = 0.0953487;
...
Lambda_LL_Mew_Input = 0.0001822;
Lambda_LL_Sigma_Input = 0.0675824;
...
DL_Mew_Input = 4.8413817;
DL_Sigma_Input = 1.1866874;
[Equivalent_Mean_DL, Equivalent_SD_DL] = Lognormal_Equivalent_Normal_Mean_and_SD_SUBF(Initial_Design_Points_For_Input(3),DL_Mew_Input,DL_Sigma_Input); %First Equivalent inital values for DL



LL_Mew_Input = 5.37088799;
LL_Sigma_Input = 0.6670649;
[Equivalent_Mean_LL, Equivalent_SD_LL] = Lognormal_Equivalent_Normal_Mean_and_SD_SUBF(Initial_Design_Points_For_Input(4), LL_Mew_Input, LL_Sigma_Input); %First Equivalent inital values for LL
...
Equivelent_Means_For_Input = [Equivalent_Mean_Lambda_DL; Equivalent_Mean_Lambda_LL; Equivalent_Mean_DL; Equivalent_Mean_LL]; %Vector of equivelent Means ****
Equivelent_SDs_For_Input = [Equivalent_SD_Lambda_DL; Equivalent_SD_Lambda_LL; Equivalent_SD_DL; Equivalent_SD_LL]; %Vector of equivelent Standard Deviations ****
...
for a = 1:Number_of_Itterations+1
    ...
    elseif a == 1 %If on first itteration of the loop
        ...
        Equivelent_Mean_Storage(3,a) = Equivalent_Mean_DL; %Store DL Equivelent Mean
        Equivelent_SD_Storage(3,a) = Equivalent_SD_DL; %Store DL Equivelent SD
        ...
        Equivelent_Mean_Storage(5,a) = Equivalent_Mean_Lambda_R; %Store Lambda_R Equivelent Mean
        Equivelent_SD_Storage(5,a) = Equivalent_SD_Lambda_R; %Store Lambda_R Equivelent SD
        ...
        [Equivalent_Mean_DL, Equivalent_SD_DL] = Lognormal_Equivalent_Normal_Mean_and_SD_SUBF(Old_Design_Points(3),DL_Mew_Input,DL_Sigma_Input); %Equivalent values for DL
        Equivelent_Mean_Storage(3,a) = Equivalent_Mean_DL; %Store DL Equivelent Mean
        Equivelent_SD_Storage(3,a) = Equivalent_SD_DL; %Store DL Equivelent SD
        

        [Equivalent_Mean_LL, Equivalent_SD_LL] = Lognormal_Equivalent_Normal_Mean_and_SD_SUBF(Old_Design_Points(4), LL_Mew_Input, LL_Sigma_Input); %Equivalent values for LL
        Equivelent_Mean_Storage(4,a) = Equivalent_Mean_LL; %Store LL Equivelent Mean
        Equivelent_SD_Storage(4,a) = Equivalent_SD_LL; %Store LL Equivelent SD

        
        [Equivalent_Mean_Lambda_R, Equivalent_SD_Lambda_R] = Lognormal_Equivalent_Normal_Mean_and_SD_SUBF(Old_Design_Points(5), Lambda_R_Mew_Input, Lambda_R_Sigma_Input); %Equivalent values for Lambda_R
        Equivelent_Mean_Storage(5,a) = Equivalent_Mean_Lambda_R; %Store Lambda_R Equivelent Mean
        Equivelent_SD_Storage(5,a) = Equivalent_SD_Lambda_R; %Store Lambda_R Equivelent SD
        ...
        Equivelent_Means_For_Input = [Equivalent_Mean_Lambda_DL; Equivalent_Mean_Lambda_LL; Equivalent_Mean_DL; Equivalent_Mean_LL; Equivalent_Mean_Lambda_R]; %Vector of equivelent Means ****
        Equivelent_SDs_For_Input = [Equivalent_SD_Lambda_DL; Equivalent_SD_Lambda_LL; Equivalent_SD_DL; Equivalent_SD_LL; Equivalent_SD_Lambda_R]; %Vector of equivelent Standard Deviations ****
