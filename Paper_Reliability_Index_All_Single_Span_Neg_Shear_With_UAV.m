...
Initial_Design_Point_Lambda_R = 1.14;
...
Lambda_R_Mew_Input = 0.1255;
Lambda_R_Sigma_Input = 0.1047;
...
[Equivalent_Mean_DL, Equivalent_SD_DL] = SHASH_Equivalent_Normal_Mean_and_SD_SUBF(Initial_Design_Points_For_Input(4),DL_Theta_Input,DL_Sigma_Input,DL_Gamma_Input,DL_Delta_Input); %First Equivalent inital values for DL
...
Lambda_UAV_Gamma_Input = -0.9391;
Lambda_UAV_Delta_Input = 1.86695;
Lambda_UAV_Theta_Input = 0.83391;
Lambda_UAV_Sigma_Input = 0.31756;
[Equivalent_Mean_Lambda_UAV, Equivalent_SD_Lambda_UAV] = Johnson_Su_Equivalent_Normal_Mean_and_SD_SUBF(Initial_Design_Points_For_Input(6), Lambda_UAV_Theta_Input,Lambda_UAV_Sigma_Input,Lambda_UAV_Gamma_Input,Lambda_UAV_Delta_Input); %First Equivalent inital values for Lambda_UAV
...
for a = 1:Number_of_Itterations+1
    ...
    elseif a == 1 %If on first itteration of the loop
        ...
        [Equivalent_Mean_DL, Equivalent_SD_DL] = SHASH_Equivalent_Normal_Mean_and_SD_SUBF(Old_Design_Points(4),DL_Theta_Input,DL_Sigma_Input,DL_Gamma_Input,DL_Delta_Input); %Equivalent values for DL
        Equivelent_Mean_Storage(4,a) = Equivalent_Mean_DL; %Store DL Equivelent Mean
        Equivelent_SD_Storage(4,a) = Equivalent_SD_DL; %Store DL Equivelent SD
        ...
        [Equivalent_Mean_Lambda_UAV, Equivalent_SD_Lambda_UAV] = Johnson_Su_Equivalent_Normal_Mean_and_SD_SUBF(Old_Design_Points(6), Lambda_UAV_Theta_Input,Lambda_UAV_Sigma_Input,Lambda_UAV_Gamma_Input,Lambda_UAV_Delta_Input); %Equivalent values for Lambda_UAV
        Equivelent_Mean_Storage(6,a) = Equivalent_Mean_Lambda_UAV; %Store Lambda_UAV Equivelent Mean
        Equivelent_SD_Storage(6,a) = Equivalent_SD_Lambda_UAV; %Store Lambda_UAV Equivelent SD
