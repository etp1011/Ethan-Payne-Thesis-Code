...
Initial_Design_Point_Lambda_DL = 0.9981304;
Initial_Design_Point_Lambda_LL = 1.0096187;
Initial_Design_Point_LL = 35.29;
...
Lambda_DL_Mew_Input = -0.005614;
Lambda_DL_Sigma_Input = 0.0859083;
[Equivalent_Mean_Lambda_DL, Equivalent_SD_Lambda_DL] = Lognormal_Equivalent_Normal_Mean_and_SD_SUBF(Initial_Design_Points_For_Input(2),Lambda_DL_Mew_Input,Lambda_DL_Sigma_Input); %First Equivalent inital values for Lambda_DL


Lambda_LL_Alpha_Input = 137.20355;
Lambda_LL_Beta_Input = 0.0073585;
[Equivalent_Mean_Lambda_LL, Equivalent_SD_Lambda_LL] = Gamma_Equivalent_Normal_Mean_and_SD_SUBF(Initial_Design_Points_For_Input(3),Lambda_LL_Alpha_Input,Lambda_LL_Beta_Input); %First Equivalent inital values for Lambda_LL


LL_Gamma_Input = -0.377884;
LL_Delta_Input = 0.6503709;
LL_Theta_Input = 30.040476;
LL_Sigma_Input = 4.3596275;
...
DL_Gamma_Input = -4.600402;
DL_Delta_Input = 1.1319032;
DL_Theta_Input = -1.073283;
DL_Sigma_Input = 0.8057577;
...
for a = 1:Number_of_Itterations+1
    ...
    elseif a == 1 %If on first itteration of the loop
        ...
        [Equivalent_Mean_Lambda_LL, Equivalent_SD_Lambda_LL] = Gamma_Equivalent_Normal_Mean_and_SD_SUBF(Old_Design_Points(3),Lambda_LL_Alpha_Input,Lambda_LL_Beta_Input); %Equivalent values for Lambda_LL
        Equivelent_Mean_Storage(3,a) = Equivalent_Mean_Lambda_LL; %Store Lambda_LL Equivelent Mean
        Equivelent_SD_Storage(3,a) = Equivalent_SD_Lambda_LL; %Store Lambda_LL Equivelent SD
