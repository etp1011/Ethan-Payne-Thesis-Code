...
[Equivalent_Mean_Lambda_DL, Equivalent_SD_Lambda_DL] = Johnson_Su_Equivalent_Normal_Mean_and_SD_SUBF(Initial_Design_Points_For_Input(3), Lambda_DL_Theta_Input,Lambda_DL_Sigma_Input,Lambda_DL_Gamma_Input,Lambda_DL_Delta_Input); %First Equivalent inital values for Lambda_DL


Lambda_LL_Mew_Input = 0.0012577;
Lambda_LL_Sigma_Input = 0.0204727;
[Equivalent_Mean_Lambda_LL, Equivalent_SD_Lambda_LL] = Lognormal_Equivalent_Normal_Mean_and_SD_SUBF(Initial_Design_Points_For_Input(4), Lambda_LL_Mew_Input,Lambda_LL_Sigma_Input); %First Equivalent inital values for Lambda_LL
...
for a = 1:Number_of_Itterations+1
    ...
    elseif a == 1 %If on first itteration of the loop
        ...
        [Equivalent_Mean_Lambda_DL, Equivalent_SD_Lambda_DL] = Johnson_Su_Equivalent_Normal_Mean_and_SD_SUBF(Old_Design_Points(3), Lambda_DL_Theta_Input,Lambda_DL_Sigma_Input,Lambda_DL_Gamma_Input,Lambda_DL_Delta_Input); %Equivalent values for Lambda_DL
        Equivelent_Mean_Storage(3,a) = Equivalent_Mean_Lambda_DL; %Store Lambda_DL Equivelent Mean
        Equivelent_SD_Storage(3,a) = Equivalent_SD_Lambda_DL; %Store Lambda_DL Equivelent SD

        
        [Equivalent_Mean_Lambda_LL, Equivalent_SD_Lambda_LL] = Lognormal_Equivalent_Normal_Mean_and_SD_SUBF(Old_Design_Points(4), Lambda_LL_Mew_Input,Lambda_LL_Sigma_Input); %Equivalent values for Lambda_LL
        Equivelent_Mean_Storage(4,a) = Equivalent_Mean_Lambda_LL; %Store Lambda_LL Equivelent Mean
        Equivelent_SD_Storage(4,a) = Equivalent_SD_Lambda_LL; %Store Lambda_LL Equivelent SD
