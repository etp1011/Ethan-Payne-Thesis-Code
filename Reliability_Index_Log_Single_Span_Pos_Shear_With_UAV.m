...
% [Equivalent_Mean_Lambda_UAV, Equivalent_SD_Lambda_UAV] = Lognormal_Equivalent_Normal_Mean_and_SD_SUBF(Initial_Design_Points_For_Input(2), Lambda_UAV_Mew_Input, Lambda_UAV_Sigma_Input); %First Equivalent inital values for Lambda_UAV
