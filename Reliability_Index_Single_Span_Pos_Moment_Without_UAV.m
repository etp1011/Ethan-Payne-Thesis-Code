...
[Equivalent_Mean_Lambda_DL, Equivalent_SD_Lambda_DL] = SHASH_Equivalent_Normal_Mean_and_SD_SUBF(Initial_Design_Points_For_Input(2),Lambda_DL_Theta_Input,Lambda_DL_Sigma_Input,Lambda_DL_Gamma_Input,Lambda_DL_Delta_Input); %First Equivalent inital values for Lambda_DL
...
for a = 1:Number_of_Itterations+1
    ...
    elseif a == 1 %If on first itteration of the loop
        ...
        [Equivalent_Mean_Lambda_DL, Equivalent_SD_Lambda_DL] = SHASH_Equivalent_Normal_Mean_and_SD_SUBF(Old_Design_Points(2), Lambda_DL_Theta_Input,Lambda_DL_Sigma_Input,Lambda_DL_Gamma_Input,Lambda_DL_Delta_Input); %Equivalent values for Lambda_DL
        Equivelent_Mean_Storage(2,a) = Equivalent_Mean_Lambda_DL; %Store Lambda_DL Equivelent Mean
        Equivelent_SD_Storage(2,a) = Equivalent_SD_Lambda_DL; %Store Lambda_DL Equivelent SD
