...
syms Lambda_R DL LL Lambda_DL Lambda_LL %Define random variables of limit state function ****

g = Lambda_R*((1.25*DL+1.75*LL)/0.9)-(Lambda_DL*DL+Lambda_LL*LL); %Limit state function ****

Variables_For_Input = [Lambda_R; Lambda_DL; Lambda_LL; LL; DL]; %Random Variable Vector of Limit State Function (Last variable is does not require a Initial Design Point[x*])****
...
Initial_Design_Point_Lambda_DL = 1.0085227;
Initial_Design_Point_Lambda_LL = 1.0025271;
Initial_Design_Point_LL = 266.04;

Initial_Design_Points_For_Input = [Initial_Design_Point_Lambda_R; Initial_Design_Point_Lambda_DL; Initial_Design_Point_Lambda_LL; Initial_Design_Point_LL]; %Vector of Initial Design Points (x*) [None required for last variable listed if Variables vector] ****
...
Lambda_DL_Gamma_Input = -0.205988;
Lambda_DL_Delta_Input = 0.8695791;
Lambda_DL_Theta_Input = 0.9858922;
Lambda_DL_Sigma_Input = 0.0522148;
[Equivalent_Mean_Lambda_DL, Equivalent_SD_Lambda_DL] = Johnson_Su_Equivalent_Normal_Mean_and_SD_SUBF(Initial_Design_Points_For_Input(2),Lambda_DL_Theta_Input,Lambda_DL_Sigma_Input,Lambda_DL_Gamma_Input,Lambda_DL_Delta_Input); %First Equivalent inital values for Lambda_DL


Lambda_LL_Gamma_Input = -0.140906;
Lambda_LL_Delta_Input = 0.9965422;
Lambda_LL_Theta_Input = 0.9904091;
Lambda_LL_Sigma_Input = 0.0443262;
[Equivalent_Mean_Lambda_LL, Equivalent_SD_Lambda_LL] = Johnson_Su_Equivalent_Normal_Mean_and_SD_SUBF(Initial_Design_Points_For_Input(3),Lambda_LL_Theta_Input,Lambda_LL_Sigma_Input,Lambda_LL_Gamma_Input,Lambda_LL_Delta_Input); %First Equivalent inital values for Lambda_LL


LL_Gamma_Input = -4.496255;
LL_Delta_Input = 1.0618291;
LL_Theta_Input = 21.772728;
LL_Sigma_Input = 5.1658389;
[Equivalent_Mean_LL, Equivalent_SD_LL] = SHASH_Equivalent_Normal_Mean_and_SD_SUBF(Initial_Design_Points_For_Input(4),LL_Theta_Input,LL_Sigma_Input,LL_Gamma_Input, LL_Delta_Input); %First Equivalent inital values for LL




%Last variable input values (Subfunction is in the a=1 part of loop) 
DL_Gamma_Input = -3.594927;
DL_Delta_Input = 0.6591837;
DL_Theta_Input = 4.3558479;
DL_Sigma_Input = 0.9046117;



%All Equivelent values except for the ones not yet calculated 
Equivelent_Means_For_Input = [Equivalent_Mean_Lambda_R; Equivalent_Mean_Lambda_DL; Equivalent_Mean_Lambda_LL;Equivalent_Mean_LL]; %Vector of equivelent Means ****
Equivelent_SDs_For_Input = [Equivalent_SD_Lambda_R; Equivalent_SD_Lambda_DL; Equivalent_SD_Lambda_LL;Equivalent_SD_LL]; %Vector of equivelent Standard Deviations ****
...
for a = 1:Number_of_Itterations+1
    ...
    elseif a == 1 %If on first itteration of the loop
        ...
        Equivelent_Mean_Storage(4,a) = Equivalent_Mean_LL; %Store LL Equivelent Mean
        Equivelent_SD_Storage(4,a) = Equivalent_SD_LL; %Store LL Equivelent SD

        Equivelent_Mean_Storage(5,a) = Equivalent_Mean_DL; %Store DL Equivelent Mean
        Equivelent_SD_Storage(5,a) = Equivalent_SD_DL; %Store DL Equivelent SD
        ...
        [Equivalent_Mean_Lambda_DL, Equivalent_SD_Lambda_DL] = Johnson_Su_Equivalent_Normal_Mean_and_SD_SUBF(Old_Design_Points(2),Lambda_DL_Theta_Input,Lambda_DL_Sigma_Input,Lambda_DL_Gamma_Input,Lambda_DL_Delta_Input); %Equivalent values for Lambda_DL
        Equivelent_Mean_Storage(2,a) = Equivalent_Mean_Lambda_DL; %Store Lambda_DL Equivelent Mean
        Equivelent_SD_Storage(2,a) = Equivalent_SD_Lambda_DL; %Store Lambda_DL Equivelent SD

        
        [Equivalent_Mean_Lambda_LL, Equivalent_SD_Lambda_LL] = Johnson_Su_Equivalent_Normal_Mean_and_SD_SUBF(Old_Design_Points(3),Lambda_LL_Theta_Input,Lambda_LL_Sigma_Input,Lambda_LL_Gamma_Input,Lambda_LL_Delta_Input); %Equivalent values for Lambda_LL
        Equivelent_Mean_Storage(3,a) = Equivalent_Mean_Lambda_LL; %Store Lambda_LL Equivelent Mean
        Equivelent_SD_Storage(3,a) = Equivalent_SD_Lambda_LL; %Store Lambda_LL Equivelent SD

        
        [Equivalent_Mean_LL, Equivalent_SD_LL] = SHASH_Equivalent_Normal_Mean_and_SD_SUBF(Old_Design_Points(4),LL_Theta_Input,LL_Sigma_Input,LL_Gamma_Input, LL_Delta_Input); %Equivalent values for LL
        Equivelent_Mean_Storage(4,a) = Equivalent_Mean_LL; %Store LL Equivelent Mean
        Equivelent_SD_Storage(4,a) = Equivalent_SD_LL; %Store LL Equivelent SD

        
        [Equivalent_Mean_DL, Equivalent_SD_DL] = SHASH_Equivalent_Normal_Mean_and_SD_SUBF(Old_Design_Points(5),DL_Theta_Input,DL_Sigma_Input,DL_Gamma_Input,DL_Delta_Input); %Equivalent values for DL
        Equivelent_Mean_Storage(5,a) = Equivalent_Mean_DL; %Store DL Equivelent Mean
        Equivelent_SD_Storage(5,a) = Equivalent_SD_DL; %Store DL Equivelent SD
        ...
        Equivelent_Means_For_Input = [Equivalent_Mean_Lambda_R; Equivalent_Mean_Lambda_DL; Equivalent_Mean_Lambda_LL; Equivalent_Mean_LL; Equivalent_Mean_DL]; %Vector of equivelent Means ****
        Equivelent_SDs_For_Input = [Equivalent_SD_Lambda_R; Equivalent_SD_Lambda_DL; Equivalent_SD_Lambda_LL; Equivalent_SD_LL; Equivalent_SD_DL]; %Vector of equivelent SDs ****
