...
Initial_Design_Points_For_Input = [Initial_Design_Point_Lambda_R; Initial_Design_Point_Lambda_DL; Initial_Design_Point_Lambda_LL; Initial_Design_Point_DL; Initial_Design_Point_LL;]; %Vector of Initial Design Points (x*) [None required for last variable listed if Variables vector] ****
...
Equivelent_Means_For_Input = [Equivalent_Mean_Lambda_R; Equivalent_Mean_Lambda_DL; Equivalent_Mean_Lambda_LL; Equivalent_Mean_DL; Equivalent_Mean_LL]; %Vector of equivelent Means ****
Equivelent_SDs_For_Input = [Equivalent_SD_Lambda_R; Equivalent_SD_Lambda_DL; Equivalent_SD_Lambda_LL; Equivalent_SD_DL; Equivalent_SD_LL]; %Vector of equivelent Standard Deviations ****
...
for a = 1:Number_of_Itterations+1
    ...
    elseif a == 1 %If on first itteration of the loop
        ...
        [Equivalent_Mean_Lambda_UAV, Equivalent_SD_Lambda_UAV] = Lognormal_Equivalent_Normal_Mean_and_SD_SUBF(Initial_Design_Point_For_Final_Variable,Lambda_UAV_Mew_Input,Lambda_UAV_Sigma_Input); %First Equivalent inital values for Lambda_UAV
        ...
        Equivelent_Means_For_Input(Number_of_Variables,1) = Equivalent_Mean_Lambda_UAV; %Add calculated equivelent Mean ****
        Equivelent_SDs_For_Input(Number_of_Variables,1) =  Equivalent_SD_Lambda_UAV; %Add calculated equivelent SD ****
        ...
        [Equivalent_Mean_Lambda_UAV, Equivalent_SD_Lambda_UAV] = Lognormal_Equivalent_Normal_Mean_and_SD_SUBF(Old_Design_Points(6), Lambda_UAV_Mew_Input, Lambda_UAV_Sigma_Input); %Equivalent values for Lambda_UAV
        Equivelent_Mean_Storage(6,a) = Equivalent_Mean_Lambda_UAV; %Store Lambda_UAV Equivelent Mean
        Equivelent_SD_Storage(6,a) = Equivalent_SD_Lambda_UAV; %Store Lambda_UAV Equivelent SD
