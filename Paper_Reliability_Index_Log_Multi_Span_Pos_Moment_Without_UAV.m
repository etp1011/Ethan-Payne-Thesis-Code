...
Variables_For_Input = [Lambda_R; Lambda_DL; Lambda_LL; DL; LL]; %Random Variable Vector of Limit State Function (Last variable is does not require a Initial Design Point[x*])****

Number_of_Variables = length(Variables_For_Input); %Determine how many variables there are

syms U_Lambda_R U_Lambda_DL U_Lambda_LL U_DL U_LL %Define Limit State function in terms of U ****

U_Variables_For_Input = [U_Lambda_R; U_Lambda_DL; U_Lambda_LL; U_DL; U_LL]; %U Random Variable Vector ****
